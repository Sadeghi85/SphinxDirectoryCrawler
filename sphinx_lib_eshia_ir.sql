...
MySQL - 5.6.16-log : Database - sphinx_lib_eshia_ir
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`sphinx_lib_eshia_ir` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `sphinx_lib_eshia_ir`;
